        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 bg-dark">
                <div class="media align-items-end profile-header">
                    <div class="profile mt-2 mr-4"><img src="/user/avatar/<?=$profile['avatar']?>" alt="avatar" width="130" class="rounded mb-2 img-thumbnail">
                    <a class="btn btn-dark btn-sm btn-block" href="<?php echo base_url(); ?>user/view/<?=$profile['username']?>">Edit profile</a></div>
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0"><?=$profile['first_name']?> <?=$profile['last_name']?></h4>
                        <p class="small mb-4"> <i class="fa fa-map-marker mr-2"></i><?=$profile['country']?></p>
                    </div>
                </div>
            </div>
